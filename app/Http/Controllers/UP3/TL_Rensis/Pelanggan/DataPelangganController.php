...
namespace App\Http\Controllers\UP3\TL_Rensis\Pelanggan;
...
class DataPelangganController extends Controller
{
    ...
    {
        //
        return view('up3.tl-rensis.pelanggan.index');
    }
    ...
    {
        //
        return view('up3.tl-rensis.pelanggan.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('pelanggan-tl-rensis.index')->with(['success' => 'Data Pelanggan Berhasil Disimpan']);
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        return view('up3.tl-rensis.pelanggan.show', compact('dataPelanggan', 'formatDate'));
    }
    ...
    public function ShowDetailDataPelanggan($id)
    {
        ...
        return DataTables::of($dataPelangganPasang)
            ...
            ->addColumn('jumlah_total_mdu', function ($row) {
                return $row->pivot->jumlah_total_mdu;
            })
            ->addColumn('total_rp_jasa', function ($row) {
                return $row->total_rp_jasa;
            })
            ->addColumn('jumlah_total_jasa', function ($row) {
                return $row->pivot->jumlah_total_jasa;
            })
            ->addColumn('nilai_rab_mdu', function ($row) {
    ...
    public function edit(Request $request, $id)
    {
        ...
        $dataPelanggan = DataPelanggan::findOrFail($id);
        $dataPelangganPasang = $dataPelanggan->pasangmaterial;
        return view('up3.tl-rensis.pelanggan.edit', compact('dataPelanggan', 'dataPelangganPasang'));
    }
    ...
    public function UpdateApprovalRensis(Request $request, $id)
    {
        ...
        $dataPelanggan->alasan_tolak_rensis = $request->alasan_tolak_rensis;
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('pelanggan-tl-rensis.index')->with(['success' => 'Data Pelanggan Berhasil Dihapus']);
    }
}
