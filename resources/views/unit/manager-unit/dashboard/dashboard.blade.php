...
<x-app-layout>
    <div
        class="max-w-7xl sticky top-0 z-10 mx-auto sm:px-6 lg:px-8 overflow-hidden shadow-sm p-4 bg-gradient-to-r from-emerald-500 to-cyan-500 text-gray-100 sm:rounded-b-lg">
