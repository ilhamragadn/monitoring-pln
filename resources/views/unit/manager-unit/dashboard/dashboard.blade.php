...
<x-app-layout>
    <div
        class="max-w-7xl sticky top-0 z-10 mx-auto sm:px-6 lg:px-8 overflow-hidden shadow-sm p-4 bg-gradient-to-r from-emerald-500 to-cyan-500 text-gray-100 rounded-b-lg">
    ...
    <div class="p-4">
        <div
            class="max-w-7xl mx-auto mb-1 pb-1 sm:px-6 lg:px-8 bg-gradient-to-r from-emerald-700 to-cyan-800 dark:text-gray-100 overflow-hidden shadow-sm rounded-lg">
        </div>
