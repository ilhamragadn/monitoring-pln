...
<x-app-layout>
    <div class="mt-16 p-4">
        @if (
            ...
            <form class="sticky top-16" action="{{ route('pelanggan-mngr-unit.UpdateApprovalUnit', $dataPelanggan->id) }}"
                method="post">
                @csrf
                <div
                    ...
                    <x-danger-button id="persetujuan_unit" name="persetujuan_unit" value="TOLAK" class="float-right m-1">
                        {{ __('TOLAK') }}
                        <input type="hidden" name="id_mngr_unit" value="{{ Auth::user()->id }}" />
                    </x-danger-button>

                    <x-safe-button id="persetujuan_unit" name="persetujuan_unit" value="SETUJU" class="float-right m-1">
                        {{ __('SETUJU') }}
                        <input type="hidden" name="id_mngr_unit" value="{{ Auth::user()->id }}" />
                    </x-safe-button>
        ...
        @if (
            ...
            <div
                ...
                <div class="flex">
                    ...
                    <p class="mt-1 font-medium text-sm text-sky-800 dark:text-sky-800">
                        Mohon maaf. Data pelanggan berikut ini telah ditolak oleh TL Rensis, terima kasih.
                    </p>
                </div>
            </div>
        @endif
        ...
        @if (
            ...
            <div
                ...
                <div class="flex">
                    ...
                    <p class="mt-1 font-medium text-sm text-sky-800 dark:text-sky-800">
                        Data pelanggan berikut ini telah Anda, TL Rensis setujui sebelumnya dan telah disetujui oleh
                        Manager Perencanaan
                        juga, terima kasih.
                    </p>
                </div>
        ...
        @if (
            ...
            <div
                ...
                <div class="flex">
                    ...
                    <p class="mt-1 font-medium text-sm text-sky-800 dark:text-sky-800">
                        Mohon maaf. Data pelanggan berikut ini telah Anda, TL Rensis setujui sebelumnya. Namun, telah
                        ditolak oleh
        ...
        <div
            ...
            <div class="grid grid-cols-2 gap-4 my-6 ">
                ...
                <div>
                    ...
                    <x-text-input id="ulp" class="block mt-1 w-full" value="{{ $dataPelanggan->ulp }}"
                        readonly />
                </div>
                <div>
