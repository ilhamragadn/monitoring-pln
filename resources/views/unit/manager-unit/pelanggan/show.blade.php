                ...
                <x-modal class="flex items-center justify-center" name="confirm-tolak-data-pelanggan" focusable>
                    <form action="{{ route('pelanggan-mngr-unit.update', $dataPelanggan->id) }}" method="POST">
                        ...
                        <div class="p-6">
                            ...
                            <div>
                                <x-textarea-input class="w-full m-2" id="alasan_tolak_unit"
                                    placeholder="Tuliskan alasan penolakannya disini" name="alasan_tolak_unit" required>
                                </x-textarea-input>
                            </div>
                            <div class="mt-6 flex justify-end">
                                ...
                                <x-danger-button id="persetujuan_unit" name="persetujuan_unit" value="TOLAK"
                                    class="ml-3">
                                    {{ __('Tolak Data Calon Pelanggan') }}
                                    <input type="hidden" name="id_mngr_unit" value="{{ Auth::user()->id }}" />
                                </x-danger-button>
                            </div>
                        </div>
                    </form>
                    ...
                    <form action="{{ route('pelanggan-mngr-unit.update', $dataPelanggan->id) }}" method="POST">
                        ...
                        <div class="p-6">
                            ...
                            <div class="mt-6 flex justify-end">
                                ...
                                <x-safe-button id="persetujuan_unit" name="persetujuan_unit" value="SETUJU"
                                    class="ml-3">
                                    {{ __('Setuju Data Calon Pelanggan') }}
                                    <input id="id_mngr_unit" type="hidden" name="id_mngr_unit"
                                        value="{{ Auth::user()->id }}" />
                                </x-safe-button>
                            </div>
                        </div>
        ...
        <div
            ...
            <div class="flex">
                ...
                <p class="mt-1 font-medium text-sm text-sky-800 dark:text-sky-800">
                    ...
                    - {{ $dataPelanggan->alasan_tolak_unit }} <br> Terima kasih.
                </p>
            </div>
        </div>
    @endif
    ...
    @if (
        ...
        <div
            ...
            <div class="flex">
                ...
                <p class="mt-1 font-medium text-sm text-sky-800 dark:text-sky-800">
                    Mohon maaf. Data pelanggan berikut ini telah ditolak oleh TL Rensis dengan alasan: <br>
                    - {{ $dataPelanggan->alasan_tolak_rensis }} <br> Terima kasih.
                </p>
            </div>
        </div>
    @endif
    ...
    @if (
        ...
        <div
            ...
            <div class="flex">
                ...
                <p class="mt-1 font-medium text-sm text-sky-800 dark:text-sky-800">
                    Data pelanggan berikut ini telah Anda setujui sebelumnya dan telah disetujui oleh TL Rensis
                    juga, terima kasih.
                </p>
            </div>
        </div>
    ...
    @if (
        ...
        <div
            ...
            <div class="flex">
                ...
                <p class="mt-1 font-medium text-sm text-sky-800 dark:text-sky-800">
                    Data pelanggan berikut ini telah Anda dan TL Rensis setujui sebelumnya dan telah disetujui oleh
                    Manager Perencanaan
                    juga, terima kasih.
                </p>
            </div>
    ...
    @if (
        ...
        <div
            ...
            <div class="flex">
                ...
                <p class="mt-1 font-medium text-sm text-sky-800 dark:text-sky-800">
                    Mohon maaf. Data pelanggan berikut ini telah Anda dan TL Rensis setujui sebelumnya. Namun, telah
                    ditolak oleh
                    Manager Perencanaan dengan alasan: <br>
                    - {{ $dataPelanggan->alasan_tolak_ren }} <br> Terima kasih.
                </p>
            </div>
        </div>
    @endif
                                                    ...
                                                    <div class="relative">
                                                        ...
                                                        <div class="absolute inset-0 flex items-center justify-center">
                                                            <a class="flex items-center justify-center text-white font-medium group/edit invisible hover:bg-green-400 hover:text-black bg-gray-500 rounded-full py-2 px-4 group-hover/item:visible"
                                                                href="{{ route('download-survei-unit', ['fileName' => $foto_survei]) }}">
