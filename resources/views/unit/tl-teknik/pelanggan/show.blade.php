...
<x-app-layout>
    @if (
        $dataPelanggan->persetujuan_unit == 'TUNGGU' &&
        ...
        <div
            ...
            <div class="flex">
                ...
                <p class="mt-1 font-medium text-sm text-sky-800 dark:text-sky-800">
                    Data pelanggan berikut ini sedang dalam proses persetujuan.
                </p>
            </div>
        </div>
    @elseif (
        ...
        <div
            ...
            <div class="flex">
                ...
                <p class="mt-1 font-medium text-sm text-sky-800 dark:text-sky-800">
                    Data pelanggan berikut ini telah disetujui oleh Manager Unit.
                </p>
            </div>
        </div>
    @elseif (
        ...
        <div
            ...
            <div class="flex">
                ...
                <p class="mt-1 font-medium text-sm text-sky-800 dark:text-sky-800">
                    Mohon maaf. Data pelanggan berikut ini telah ditolak oleh Manager Unit dengan alasan: <br>
                    - {{ $dataPelanggan->alasan_tolak_unit }} <br>
                    Terima kasih.
                </p>
            </div>
        </div>
    @elseif (
        ...
        <div
            ...
            <div class="flex">
                ...
                <p class="mt-1 font-medium text-sm text-sky-800 dark:text-sky-800">
                    Data pelanggan berikut ini telah disetujui oleh Manager Unit dan TL Rensis.
                </p>
            </div>
        </div>
    @elseif (
        ...
        <div
            ...
            <div class="flex">
                ...
                <p class="mt-1 font-medium text-sm text-sky-800 dark:text-sky-800">
                    Mohon maaf. Data pelanggan berikut ini telah disetujui oleh Manager Unit. Namun, ditolak oleh TL
                    Rensis dengan alasan: <br>
    ...
    @elseif (
        ...
        <div
            ...
            <div class="flex">
                ...
                <p class="mt-1 font-medium text-sm text-sky-800 dark:text-sky-800">
                    Data pelanggan berikut ini telah disetujui oleh Manager Unit, TL Rensis, dan Manager
                    Perencanaan.
                </p>
            </div>
        </div>
    @elseif (
        ...
        <div
            ...
            <div class="flex">
                ...
                <p class="mt-1 font-medium text-sm text-sky-800 dark:text-sky-800">
                    Mohon maaf. Data pelanggan berikut ini telah disetujui oleh Manager Unit, TL Rensis. Namun,
                    telah ditolak
                    oleh Manager
                    Perencanaan dengan alasan: <br>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        <div class="border-b border-dashed m-1 text-lg text-center">
            <x-input-label
        ...
        <div class="my-4 mx-2">
            ...
            <div class="p-2 border border-gray-300 dark:border-none dark:bg-gray-900 rounded-md shadow-sm">
                @include('unit.tl-teknik.pelanggan.tables.detail-table-pasang')
            </div>
        </div>

        @if ($dataPelanggan->persetujuan_unit == 'TOLAK' || $dataPelanggan->persetujuan_unit == 'TUNGGU')
            <div class="grid grid-cols-3">
                <div class="col-span-1">
                    <div class="flex lg:justify-start justify-center">
                        <x-danger-button class="mb-6 mx-2" x-data=""
                ...
                <div class="col-span-2">
                    <div class="flex lg:justify-end justify-center">
                        <x-update-button class="mb-6 mx-2"
                            href="{{ route('pelanggan-tl-teknik.edit', $dataPelanggan->id) }}">
                            {{ __('Edit') }}
                        </x-update-button>
                        <x-primary-button onclick="window.history.back()" class="mb-6 mx-2">
                            {{ __('Kembali') }}
                        </x-primary-button>
                    </div>
                </div>
            ...
            <x-modal class="flex items-center justify-center" name="confirm-data-pelanggan-deletion" focusable>
                <form method="post" action="{{ route('pelanggan-tl-teknik.destroy', $dataPelanggan->id) }}"
                    class="p-6">
                    @csrf
                    @method('delete')
        ...
        @elseif ($dataPelanggan->persetujuan_rensis == 'TOLAK' && $dataPelanggan->persetujuan_unit == 'SETUJU')
            <div class="grid grid-cols-3">
                <div class="col-span-1">
                    <div class="flex lg:justify-start justify-center">
                        <x-danger-button class="mb-6 mx-2" x-data=""
        ...
        @else
            <x-primary-button onclick="window.history.back()" class="mb-6 mx-2 float-right">
                {{ __('Kembali') }}
            </x-primary-button>
        @endif
    </div>
