...
<x-app-layout>
    <div class="mt-16 p-4">
        ...
        @if (
            ...
            <div
                ...
                <div class="flex">
                    ...
                    <p class="mt-1 font-medium text-sm text-sky-800 dark:text-sky-800">
                        Mohon maaf. Data pelanggan berikut ini telah ditolak oleh Manager Unit.
                    </p>
                </div>
            </div>
        @endif
        ...
        <div
            ...
            <x-input-label class="border-b border-dashed m-1 text-lg text-center"
            ...
            <div class="grid grid-cols-2 gap-4 my-6">
                ...
                <div>
                    ...
                    <x-text-input class="block mt-1 w-full" value="{{ $dataPelanggan->jumlah_pelanggan }}"
                        readonly />
                </div>
                <div>
                ...
                <div>
                    ...
                    <x-text-input id="lama_bayar" class="block mt-1 w-full" type="text" name="lama_bayar"
                        readonly value="{{ $dataPelanggan->lama_bayar }}" />
                </div>
                <div>
                ...
                <div>
                    ...
                    <x-date-input id="tgl_reservasi_kons" name="tgl_reservasi_kons" class="block mt-1 w-full"
                        readonly value="{{ $dataPelanggan->tgl_reservasi_kons }}" />
                </div>
                <div>
            ...
            @if ($dataPelanggan->persetujuan_rensis == 'TOLAK' && $dataPelanggan->persetujuan_unit == 'SETUJU')
                <x-update-button class="mb-6 mr-2 float-right"
                    href="{{ route('pelanggan-tl-teknik.edit', $dataPelanggan->id) }}">
                    {{ __('Edit Data') }}
                </x-update-button>
