        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <form method="POST" action="{{ route('pelanggan-tl-rensis.store') }}" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-2 gap-4 my-6">
                    <input type="hidden" name="id_tl_rensis" value="{{ Auth::user()->id }}" />
                    <div>
                        <x-input-label for="no_regis" :value="__('No. Regis')" />
                        <x-text-input id="no_regis" class="block mt-1 w-full" type="text" name="no_regis"
                            autofocus />
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <x-text-input id="alamat_pelanggan" class="block mt-1 w-full" type="text"
                            name="alamat_pelanggan" :value="old('alamat_pelanggan')" required autocomplete="alamat_pelanggan" />
