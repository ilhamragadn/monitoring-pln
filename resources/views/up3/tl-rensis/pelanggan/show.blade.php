...
<x-app-layout>
    ...
    @elseif (
        $dataPelanggan->persetujuan_unit == 'SETUJU' &&
            ...
            $dataPelanggan->persetujuan_ren == 'TUNGGU')
        <div
            class="max-w-7xl mx-auto mb-6 p-2 sticky top-2 z-10 sm:px-6 sm:flex  lg:px-8 bg-sky-200 overflow-hidden shadow rounded-lg border-sky-800 dark:border-sky-800 dark:bg-sky-200">
            <div class="flex">
                @method('PUT')
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        ...
        @endif
        <div class="lg:grid grid-cols-2 gap-4 my-4 mx-2">
            <div class="mb-2">
        ...
        @elseif ($dataPelanggan->persetujuan_unit == 'SETUJU' && $dataPelanggan->persetujuan_rensis == 'TOLAK')
            <div class="grid grid-cols-3">
                <div class="col-span-1">
                    <div class="flex lg:justify-start justify-center">
                        <x-danger-button class="mb-6 mx-2" x-data=""
