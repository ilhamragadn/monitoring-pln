        ...
        @if (
            ...
            <form action="{{ route('pelanggan-tl-rensis.UpdateApprovalRensis', $dataPelanggan->id) }}" method="post"
                ...
                <div
                    ...
                    <x-danger-button id="persetujuan_rensis" name="persetujuan_rensis" value="TOLAK"
                        class="float-right m-1"> {{ __('TOLAK') }}
                        <input id="id_tl_rensis" type="hidden" name="id_tl_rensis" value="{{ Auth::user()->id }}" />
                    </x-danger-button>

                    <x-safe-button id="persetujuan_rensis" name="persetujuan_rensis" value="SETUJU"
                        class="float-right m-1"> {{ __('SETUJU') }}
                        <input id="id_tl_rensis" type="hidden" name="id_tl_rensis" value="{{ Auth::user()->id }}" />
                    </x-safe-button>
