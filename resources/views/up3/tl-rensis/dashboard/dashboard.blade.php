...
<x-app-layout>
    <div
        class="max-w-7xl mx-auto mt-14 sm:px-6 lg:px-8 overflow-hidden shadow-sm p-4 bg-gradient-to-r from-indigo-500 to-violet-500 text-gray-100 sm:rounded-b-lg">
    ...
    <div class="p-4">
        ...
        <div class="grid grid-cols-3 gap-2 my-4">
            <div>
                <a href="hargapasang-tl-rensis/create"
                    ...
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Tambah Daftar Harga
                        Pasang
                        Material +</h5>
        ...
        <div class="grid grid-cols-3 gap-3 my-4">
            ...
            <div>
                <a href="#dashboard-rensis-persetujuan-rensis"
                    class="block max-w-sm p-6 my-1 bg-gray-200 rounded-lg shadow-md hover:bg-gray-50 dark:bg-gray-800  dark:hover:bg-gray-700">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Persetujuan Data
                        Pelanggan oleh TL Rensis</h5>
                    <div class="inline-flex items-center justify-between">
                        <p class="inline-flex font-normal text-gray-700 dark:text-gray-400">Lihat disini statusnya
                            <svg class="w-4 h-4 ml-2 mt-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                fill="none" viewBox="0 0 10 14">
            ...
            <div>
                <a href="#dashboard-rensis-progress"
                    class="block max-w-sm p-6 my-1 bg-gray-200 rounded-lg shadow-md hover:bg-gray-50 dark:bg-gray-800  dark:hover:bg-gray-700">
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Perkembangan
                        Status
