...
<x-app-layout>
    <div
        class="max-w-7xl mx-auto mt-14 sm:px-6 lg:px-8 overflow-hidden shadow-sm p-4 bg-gradient-to-r from-fuchsia-500 to-rose-500 text-gray-100 sm:rounded-b-lg">
