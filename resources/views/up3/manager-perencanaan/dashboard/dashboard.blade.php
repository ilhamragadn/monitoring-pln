...
<x-app-layout>
    <div
        class="max-w-7xl sticky top-0 z-10 mx-auto sm:px-6 lg:px-8 overflow-hidden shadow-sm p-4 bg-gradient-to-r from-fuchsia-500 to-rose-500 text-gray-100 sm:rounded-b-lg">
    ...
    <div class="p-4">
        <div
            class="max-w-7xl mx-auto mb-1 pb-1 sm:px-6 lg:px-8 bg-gradient-to-r from-fuchsia-700 to-rose-800 dark:text-gray-100 overflow-hidden shadow-sm sm:rounded-lg">
        </div>
        <div class="grid grid-cols-3 gap-2 my-4">
            <div>
                <a href="hargapasang-mngr-ren"
        ...
        <div class="grid grid-cols-3 gap-3 my-4">
            ...
            <div>
                <a href="#dashboard-ren-persetujuan-tunggu"
                    class="block max-w-sm p-6 my-1 bg-gray-200  rounded-lg shadow-md hover:bg-gray-50 dark:bg-gray-800  dark:hover:bg-gray-700">
            ...
            <div>
                <a href="#dashboard-ren-persetujuan-terkonfirmasi"
                    class="block max-w-sm p-6 my-1 bg-gray-200  rounded-lg shadow-md hover:bg-gray-50 dark:bg-gray-800  dark:hover:bg-gray-700">
        ...
        <div class="p-4 my-6 bg-white rounded-lg shadow-md dark:bg-gray-800">
            @include('up3.manager-perencanaan.dashboard.tables.persetujuan-mngr-ren-tunggu')
        </div>
        <div
            class="max-w-7xl mx-auto mb-1 pb-1 sm:px-6 lg:px-8 bg-gradient-to-r from-fuchsia-700 to-rose-800 dark:text-gray-100 overflow-hidden shadow-sm sm:rounded-lg">
        </div>
        <div class="p-4 my-6 bg-white rounded-lg shadow-md dark:bg-gray-800">
            @include('up3.manager-perencanaan.dashboard.tables.persetujuan-mngr-ren-terkonfirmasi')
        </div>
        <div
            class="max-w-7xl mx-auto mb-1 pb-1 sm:px-6 lg:px-8 bg-gradient-to-r from-fuchsia-700 to-rose-800 dark:text-gray-100 overflow-hidden shadow-sm sm:rounded-lg">
        </div>
