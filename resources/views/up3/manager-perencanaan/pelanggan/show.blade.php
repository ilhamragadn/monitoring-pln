        ...
        <div class="sticky top-2 z-10">
            <div
                ...
                <x-modal class="flex items-center justify-center" name="confirm-tolak-data-pelanggan" focusable>
                    <form action="{{ route('pelanggan-mngr-ren.UpdateApprovalRen', $dataPelanggan->id) }}"
                        method="post">
                        @csrf
                        @method('PUT')
                        <div class="p-6">
                            ...
                            <div>
                                <x-textarea-input class="w-full m-2" id="alasan_tolak_ren"
                                    placeholder="Tuliskan alasan penolakannya disini" name="alasan_tolak_ren" required>
                                </x-textarea-input>
                            </div>
                            <div class="mt-6 flex justify-end">
                                ...
                                <x-danger-button class="ml-3" id="persetujuan_ren" name="persetujuan_ren"
                                    value="TOLAK">
                    ...
                    <form action="{{ route('pelanggan-mngr-ren.UpdateApprovalRen', $dataPelanggan->id) }}"
                        ...
                        <div class="p-6">
                            ...
                            <div class="mt-6 flex justify-end">
                                ...
                                <x-safe-button class="ml-3" id="persetujuan_ren" name="persetujuan_ren"
                                    value="SETUJU">
                                    {{ __('Setuju Data Calon Pelanggan') }}
                                    <input id="id_mngr_ren" type="hidden" name="id_mngr_ren"
                                        value="{{ Auth::user()->id }}" />
                                </x-safe-button>
                            </div>
                        </div>
    ...
    @elseif (
        ...
        <div
            ...
            <div class="flex">
                ...
                <p class="mt-1 font-medium text-sm text-sky-800 dark:text-sky-800">
                    Data pelanggan berikut ini telah Anda tolak dengan alasan: <br>
                    - {{ $dataPelanggan->alasan_tolak_ren }}
                </p>
            </div>
        </div>
    @endif
                                                    ...
                                                    <div class="relative">
                                                        ...
                                                        <div class="absolute inset-0 flex items-center justify-center">
                                                            <a class="flex items-center justify-center text-white font-medium group/edit invisible hover:bg-green-400 hover:text-black bg-gray-500 rounded-full py-2 px-4 group-hover/item:visible"
                                                                href="{{ route('download-survei-ren', ['fileName' => $foto_survei]) }}">
