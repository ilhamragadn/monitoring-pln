...
<x-app-layout>
    <div
        ...
        <div class="flex">
            ...
            <p class="mt-1 font-medium text-sm text-sky-800 dark:text-sky-800">
                Data calon pelanggan berikut ini adalah data yang telah disetujui oleh TL Rensis atau data yang
                dibuat oleh TL Teknik
                dengan
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        <form action="{{ route('download-dapel-ren.downloadData') }}" method="post">
            @csrf
            ...
            @include('up3.manager-perencanaan.pelanggan.tables.index-table-pasang')
        </form>
    </div>
</x-app-layout>
