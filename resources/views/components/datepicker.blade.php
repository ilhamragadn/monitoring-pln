<div x-data="app()" x-init="[initDate(), getNoOfDays()]" x-cloak>
    <div class="relative">
        ...
        <input type="text" x-on:click="showDatepicker = !showDatepicker" x-model="datepickerValue"
            ...
            class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md w-full block pl-4 pr-10 mt-1 shadow-sm text-gray-600 "
            value="" placeholder="Tentukan tanggalnya" />
        ...
        <div class="w-3/4 h-52 border-gray-300 dark:border-gray-700 dark:bg-gray-200 mt-12 rounded-lg shadow p-4 absolute left-0 bottom-12 "
                ...
                <template x-for="(date, dateIndex) in no_of_days" :key="dateIndex">
                    <div style="width: 14.28%" class="px-1 mb-1">
                        <div @click="getDateValue(date)" x-text="date"
                            class="cursor-pointer text-center text-sm leading-none rounded-full leading-lose transition ease-in-out duration-100"
                            :class="{
