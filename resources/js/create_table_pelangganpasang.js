...
// TABLE DATA CALON PELANGGAN TL Rensis
let tableCreatePelangganPasangTLRensis = new DataTable(
    "#create-pelangganpasang-rensis",
    {
        processing: true,
        responsive: true,
        serverSide: true,
        ...
        scrollX: true,
        ajax: {
            url: base_url + "/create-dapel-rensis",
            type: "post",
            dataType: "json",
            data: {
                _token: web_token,
        ...
        columns: [
            {
                ...
                orderable: false,
                searchable: false,
                className: "text-center border-b dark:border-slate-400",
                render: function (data, type, row) {
                    return (
                        '<input id="checkbox" name="material_id[]" value="' +
                        row.id +
                        '" type="checkbox" class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-green-600 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm w-5 h-5" />'
                    );
                },
            },
            {
                ...
                name: "material",
                className:
                    "text-center whitespace-nowrap border-b dark:border-slate-400",
            },
            {
                data: "satuan",
                name: "satuan",
            ...
            },
            {
                ...
                orderable: false,
                searchable: false,
                className: " border-b dark:border-slate-400",
                render: function (data, type, row) {
                    return (
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    return (
                        '<input id="jumlah-total-mdu" name="jumlah_total_mdu[' +
                        row.id +
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    return (
                        '<input id="jumlah-total-jasa" name="jumlah_total_jasa[' +
                        row.id +
                        ']" class="w-40 bg-transparent border-transparent rounded-md text-center text-sm" readonly value="' +
                        new Intl.NumberFormat("id-ID", {
                            style: "currency",
...
tableCreatePelangganPasangTLRensis.on("init.dt", function () {
    ...
    let jumlahTotalMDU = document.querySelectorAll("#jumlah-total-mdu");
    let jumlahTotalJASA = document.querySelectorAll("#jumlah-total-jasa");
    ...
    checkbox.forEach(function (checkboxElement, index) {
        checkboxElement.addEventListener("change", function () {
            ...
            const dataTable = tableCreatePelangganPasangTLRensis
                .row(this.closest("tr"))
                .data();
            ...
            if (isChecked) {
                ...
                banyak_material[index].addEventListener("input", function () {
                    ...
                    if (banyakMaterialVal == 0 && totalAllRAB == 0) {
                        ...
                        ratio = new Intl.NumberFormat("id-ID").format(
                            ratioFormula
                        );
                ...
                jumlahTotalMDU[index].value = resetVal;
                jumlahTotalJASA[index].value = resetVal;
                RAB_MDU[index].value = resetVal;
                RAB_JASA[index].value = resetVal;
                Ratio[index].value = "0";
                dataTable.total_rp_mdu = resetVal;
                dataTable.total_rp_jasa = resetVal;
                dataTable.jumlah_total_mdu = resetVal;
                dataTable.jumlah_total_jasa = resetVal;
...
let tableCreatePelangganPasangTLTeknik = new DataTable(
    "#create-pelangganpasang-teknik",
    {
        processing: true,
        responsive: true,
        serverSide: true,
        ...
        scrollX: true,
        ajax: {
            url: base_url + "/create-dapel-teknik",
            type: "post",
            dataType: "json",
            data: {
                _token: web_token,
...
tableCreatePelangganPasangTLTeknik.on("init.dt", function () {
    let checkbox = document.querySelectorAll("#checkbox");
    let banyak_material = document.querySelectorAll("#input-number");
    let total_mdu = document.querySelectorAll("#total-rp-mdu");
    let total_jasa = document.querySelectorAll("#total-rp-jasa");
    ...
    checkbox.forEach(function (checkboxElement, index) {
        checkboxElement.addEventListener("change", function () {
            const isChecked = this.checked;
            const dataTable = tableCreatePelangganPasangTLTeknik
                .row(this.closest("tr"))
                .data();
            const rp_mduValue = dataTable.rp_mdu;
            const rp_jasaValue = dataTable.rp_jasa;
